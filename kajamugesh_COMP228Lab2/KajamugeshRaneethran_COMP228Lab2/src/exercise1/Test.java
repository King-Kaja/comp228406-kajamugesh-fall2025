...
public class Test {
	...
	public int simulateQuestion(int questionIndex) {
		...
		return JOptionPane.showOptionDialog(null, question, "", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
	...
	public void inputAnswer() {
		...
		for (int i = 0; i < 5; i++) {
			...
			if (correctCheck) {
				...
				JOptionPane.showMessageDialog(null, message + " The correct answer was " + answers[i], "Test",
